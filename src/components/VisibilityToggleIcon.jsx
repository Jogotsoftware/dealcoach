...
export default function VisibilityToggleIcon({ visible, onChange, label = 'this section', size = 16, inline = false }) {
  return (
    <button
      type="button"
      ...
      style={{
        ...
        padding: inline ? 0 : '2px 4px', marginLeft: inline ? 6 : 0,
        display: 'inline-flex', alignItems: 'center', justifyContent: 'center',
        color: visible ? T.success : T.textMuted, lineHeight: 0,
